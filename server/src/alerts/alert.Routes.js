 ...
 * @access  Public
 */
router.get('/', validateDateRange, validatePagination, getAllAlerts);
 ...
 */
router.patch('/:id/acknowledge', validateAlertAcknowledgment, acknowledgeAlert);
 ...
 * @access  Public (Staff and Admin)
 */
router.patch('/:id/resolve', validateAlertResolution, resolveAlert);
